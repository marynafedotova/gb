  ...
  var T = function T(t, e, i, s) {
    ...
    return w.prototype.generateSettings = function (e) {
      ...
      if (this.lgOpened) {
        ...
        if (this.currentimgize = T(this.items[this.index], this.outer, i + s, t && this.settings.videoMaxSize), t && this.resizeVideoSlide(this.index, this.currentimgize), this.zoomFromOrigin && !this.isDummyImageRemoved) {
          var o = this.getDummyImgStyles(this.currentimgize);
      ...
      if (void 0 === t && (t = this.settings.index), !this.lgOpened) {
        ...
        this.zoomFromOrigin && e && (this.currentimgize = T(e, this.outer, d + g, h && this.settings.videoMaxSize), o = E(e, this.outer, d, g, this.currentimgize)), this.zoomFromOrigin && o || (this.outer.addClass(this.settings.startClass), this.getSlideItem(t).removeClass("lg-complete"));
      ...
      if (this.settings.dynamic || (s = x(this.items).eq(e)), s) {
        ...
        var o = "<img " + i + ' style="' + this.getDummyImgStyles(this.currentimgize) + '" class="lg-dummy-img" src="' + n + '" />';
      ...
      if (v && (b = this.zoomFromOrigin && this.currentimgize ? this.settings.startAnimationDuration + 10 : this.settings.backdropDuration + 10), !r.hasClass("lg-loaded")) {
        if (p) {
        ...
        if (y) {
          ...
          var z = "";
          v && this.zoomFromOrigin && this.currentimgize && (z = this.getDummyImageContent(r, t, ""));
      ...
      }, this.settings.startAnimationDuration + 100)), r.addClass("lg-loaded"), this.isFirstSlideWithZoomAnimation() && ("video" !== this.getSlideType(o) || l) || this.onLgObjectLoad(r, t, b, k, v, !(!p || !p.html5 || l)), this.zoomFromOrigin && this.currentimgize || !r.hasClass("lg-complete_") || this.lGalleryOn || setTimeout(function () {
