...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var utils = {
    ...
    /**
     * @desc Get transform value based on the imgize. Used for ZoomFromOrigin option
     * @param {jQuery Element}
     * @returns {String} Transform CSS string
     */
    getTransform: function getTransform(el, container, top, bottom, imgize) {
      if (!imgize) {
        return;
      }
      ...
      var scX = elWidth / imgize.width;
      var scY = elHeight / imgize.height;
    ...
    isImageLoaded: function isImageLoaded(img) {
      if (!img) return false; // During the onload event, IE correctly identifies any img that
  ...
  }; // @ref - https://stackoverflow.com/questions/3971841/how-to-resize-img-proportionally-keeping-the-aspect-ratio
  ...
  function () {
    ...
    LightGallery.prototype.normalizeSettings = function () {
      ...
      // @todo add zoomFromOrigin support for dynamic img
    ...
    LightGallery.prototype.refreshOnResize = function () {
      if (this.lgOpened) {
        ...
        var _a = this.mediaContainerPosition,
            top_1 = _a.top,
            bottom = _a.bottom;
        this.currentimgize = utils.getSize(this.items[this.index], this.outer, top_1 + bottom, __slideVideoInfo && this.settings.videoMaxSize);

        if (__slideVideoInfo) {
          this.resizeVideoSlide(this.index, this.currentimgize);
        }

        if (this.zoomFromOrigin && !this.isDummyImageRemoved) {
          var imgStyle = this.getDummyImgStyles(this.currentimgize);
    ...
    LightGallery.prototype.resizeVideoSlide = function (index, imgize) {
      var lgVideoStyle = this.getVideoContStyle(imgize);
    ...
    LightGallery.prototype.openGallery = function (index, element) {
      ...
      if (this.zoomFromOrigin && element) {
        this.currentimgize = utils.getSize(element, this.outer, top + bottom, __slideVideoInfo && this.settings.videoMaxSize);
        transform = utils.getTransform(element, this.outer, top, bottom, this.currentimgize);
      }
    ...
    LightGallery.prototype.getDummyImgStyles = function (imgize) {
      if (!imgize) return '';
      return "width:" + imgize.width + "px;\n                margin-left: -" + imgize.width / 2 + "px;\n                margin-top: -" + imgize.height / 2 + "px;\n                height:" + imgize.height + "px";
    };

    LightGallery.prototype.getVideoContStyle = function (imgize) {
      if (!imgize) return '';
      return "width:" + imgize.width + "px;\n                height:" + imgize.height + "px";
    };
    ...
    LightGallery.prototype.isFirstSlideWithZoomAnimation = function () {
      return !!(!this.lGalleryOn && this.zoomFromOrigin && this.currentimgize);
    }; // Add video slideInfo
    ...
    LightGallery.prototype.loadContent = function (index, rec) {
      ...
      if (isFirstSlide) {
        if (this.zoomFromOrigin && this.currentimgize) {
      ...
      if (!$currentSlide.hasClass('lg-loaded')) {
        ...
        if (iframe) {
          ...
          var dummyImg = '';
          var hasStartAnimation = isFirstSlide && this.zoomFromOrigin && this.currentimgize;
      ...
      if ((!this.zoomFromOrigin || !this.currentimgize) && $currentSlide.hasClass('lg-complete_') && !this.lGalleryOn) {
        setTimeout(function () {
    ...
    LightGallery.prototype.closeGallery = function (force) {
      ...
      if (this.zoomFromOrigin && currentItem) {
        ...
        var _b = this.galleryItems[this.index],
            ...
            poster = _b.poster;
        var imgize = utils.getSize(currentItem, this.outer, top_4 + bottom, __slideVideoInfo && poster && this.settings.videoMaxSize);
        transform = utils.getTransform(currentItem, this.outer, top_4, bottom, imgize);
      }
