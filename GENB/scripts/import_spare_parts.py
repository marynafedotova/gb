import json
from GOODS.models import SparePart, Categories, SubCategory, AdditionalСategory
...
import json
from myapp.models import SparePart, Categories, SubCategory, AdditionalСategory
from django.utils.text import slugify
